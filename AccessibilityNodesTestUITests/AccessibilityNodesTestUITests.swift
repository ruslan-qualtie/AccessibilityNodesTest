...
class AccessibilityNodesTestUITests: XCTestCase {
    func testExample() throws {
        ...
        let switchToFirstButton = appWindow/*@START_MENU_TOKEN@*/.buttons["Switch to First"]/*[[".groups[\"second-view\"].buttons[\"Switch to First\"]",".buttons[\"Switch to First\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
